...
3. bash
4. sudo apt update
5. sudo apt install nmap msfconsole xterm espeak ngrok
6. Python लाइब्रेरीज इंस्टॉल करें:
7. bash
8. pip install -r requirements.txt
9. (अगर requirements.txt नहीं है, तो pip install customtkinter psutil requests pyttsx3 reportlab yara-python pillow चलाएं)
